...
export const ApplicationUserDeleteDialog = (props: IApplicationUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="zimaApp.applicationUser.delete.question">
        <Translate contentKey="zimaApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>

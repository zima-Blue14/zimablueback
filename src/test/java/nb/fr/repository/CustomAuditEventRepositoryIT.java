...
import static nb.fr.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import nb.fr.config.audit.AuditEventConverter;
import nb.fr.domain.PersistentAuditEvent;

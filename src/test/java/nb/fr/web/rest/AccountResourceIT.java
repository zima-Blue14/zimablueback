...
import static nb.fr.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import nb.fr.config.Constants;
import nb.fr.domain.User;
import nb.fr.repository.AuthorityRepository;
import nb.fr.repository.UserRepository;
import nb.fr.security.AuthoritiesConstants;
import nb.fr.service.UserService;
import nb.fr.service.dto.PasswordChangeDTO;
import nb.fr.service.dto.UserDTO;
import nb.fr.web.rest.vm.KeyAndPasswordVM;
import nb.fr.web.rest.vm.ManagedUserVM;
